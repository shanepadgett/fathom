...
export const viewerShell = () =>
  html`
    <a class="fixed -top-20 left-4 z-30 bg-canvas p-3 focus:top-4"
    ...
    <div data-shell class="min-h-dvh">
      ...
      >
        ...
        <edge-resizer data-drawer-resizer edge="right"
          .bounds=${viewerSidebarBounds}></edge-resizer>
      </aside>
      <ds-button
        variant="secondary"
        data-drawer-open
      ...
      >
        <div data-content
          class="mx-auto max-w-7xl has-[[data-overview]]:max-w-none"></div>
      </main>
    </div>
  `;
