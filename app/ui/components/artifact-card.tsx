...
export function ArtifactCard(
  props: { artifact: Artifact; open(): void; approve(): Promise<unknown> },
) {
  return (
    <section
    ...
    >
      <div class="flex items-start gap-3">
        ...
        <div class="min-w-0 flex-1">
          ...
          <p class="text-xs text-muted">
            {props.artifact.name} · {props.artifact.bytes.toLocaleString()}{" "}
            bytes
          </p>
        </div>
      ...
      <div class="flex flex-wrap items-start gap-3">
        <Button variant="secondary" onClick={props.open}>Open in viewer</Button>
        <Show
          when={props.artifact.mime === "text/markdown" &&
            props.artifact.status === "pending"}
        >
