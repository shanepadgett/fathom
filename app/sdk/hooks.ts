...
export type ToolDecision = { action: "block"; reason: string } | {
  action: "prompt_user";
  explanation: string;
...
declare module "cordis" {
  interface Events {
    ...
    "tool:after"(
      input: ToolInput & { result: string; isError: boolean },
    ): void | Promise<void>;
    "step:after"(
      input: {
        sessionId: string;
      ...
      | StepContinuation
      | void
      | Promise<StepContinuation | void>;
    "run:finish"(input: { sessionId: string }): void | Promise<void>;
    "session:idle"(sessionId: string): void | Promise<void>;
    "compaction:before"(
      input: { sessionId: string; protectedIds: string[] },
    ): void | Promise<void>;
    "compaction:after"(
      input: { sessionId: string; summary: string; pinnedArtifacts: string[] },
    ): void | Promise<void>;
  }
}
