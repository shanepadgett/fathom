...
export type ViewSlot = "sidebar" | "inspector" | "drawer" | "status" | "workspace";
export type ViewMount = (element: HTMLElement, host: FrontendHost) => Dispose;

export type EntryMount = (element: HTMLElement, host: FrontendHost, entry: () => Entry) => Dispose;
...
export interface FrontendHost {
  ...
  registerView(view: { id: string; title: string; slot: ViewSlot; mount: ViewMount }): Dispose;
  ...
  registerSurfaceOverride(surface: "shell" | "transcript" | "editor", mount: ViewMount): Dispose;
